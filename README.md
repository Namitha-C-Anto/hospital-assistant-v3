...
**▶️ [Watch the full demo video](assets/hospital-assistant-rag-v3-demo.mp4)** — conversational Q&A, retrieval-mode switching, reranking, source transparency, and Docker deployment in action.
